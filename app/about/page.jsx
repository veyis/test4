...
const AboutUs = () => {
      ...
      <section className="py-12 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
            ...
            <div class="container">
    <h1>Hello there!</h1>
    <p>We are Aleksandra and Randy.</p>
    ...
    <p>As you get settled in and explore San Antonio, we hope to provide you with a wonderful and fulfilling experience. Please do not hesitate to contact us if you have any questions or need any assistance.</p>
    <p>Your comfort, enjoyment, and lasting memories are our top priorities.</p>
</div>
            </div>
          </div>
        </div>
