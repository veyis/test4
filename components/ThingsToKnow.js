// components/ThingsToKnow.js
import React from "react";

const ThingsToKnow = () => {
	return (
		<div className="max-w-7xl mx-auto p-6 bg-white shadow-lg rounded-lg">
			<h2 className="text-2xl font-bold text-gray-800 mb-6">Things to Know</h2>
			<div className="grid grid-cols-3 gap-4">
				...
				<div>
					...
					<ul className="list-disc list-inside text-gray-600">
						...
						<li>
							"House is equipped with (3) security cameras on the outside and an
				...
				<div>
					...
					<button className="text-blxue-500 hover:text-blue-700 mt-2"
